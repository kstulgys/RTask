...
test('getCanSubmit', () => {
  expect(isInputValue(-1234)).toBeFalsy();
  expect(isInputValue(-1234.123)).toBeFalsy();
  expect(isInputValue(1234.123)).toBeFalsy();
  expect(isInputValue(Infinity)).toBeFalsy();
  expect(isInputValue(-Infinity)).toBeFalsy();
  expect(isInputValue('1234.123')).toBeFalsy();
  expect(isInputValue('Infinity')).toBeFalsy();
  expect(isInputValue('-1234.123')).toBeFalsy();

  expect(isInputValue('1234.12')).toBeTruthy();
  expect(isInputValue('37846376473647836478364.12')).toBeTruthy();
});
